...
user = User.create!(:first_name => "Example", :last_name => "Admin", :email_address => "admin@example.com", :password => "llamafarm", :time_zone => "London", :email_verified_at => Time.now, :admin => true)
